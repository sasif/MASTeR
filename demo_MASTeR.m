% Demo for MASTeR 
% see MASTeR_function for further details about the parameters 
%
%-------------------------------------------+
...
% data = 3; pre = 0; rf_table = 10; % dataset 'wrap003'
data = 2; pre = 1; rf_table = 8; % dataset 'P501767'
